...
class BGSDataset(Dataset):
    ...
    def __init__(self, mode='train', data_path='', noise='', patch_n=None, patch_size=None, transform=None):
        ...
        with open(self.data_path, 'r') as f:
            for line in f:
                ...
                inp_path = line.replace('clean', 'noisy' + noise)
    ...
    def __getitem__(self, idx):
        ...
        if self.patch_size:
            input_patches, target_patches = get_patch(inp_data, gt_data, self.patch_n, self.patch_size, self.mode,
                                                      drop_background=0)
